...
export default function FavPage() {
  ...
  function handleDelete(element) {
    console.log(element);
    Swal.fire({  //this is just a alert 3rd party library
  ...
  return (
    <div>
    <Button   className={style.navBtn} onClick={() => navigate('/')} text="Add Favourite" />
      ...
      <p style={{textAlign :"center"}}>&copy; Abhishek 2023</p>
    </div>
  );
}
